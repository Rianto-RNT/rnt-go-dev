...
func main() {
	bandwidth := BandwidthUsage{[]Bytes{50000, 10000, 130000, 80000, 90000}}
	temp := CpuTemp{[]Celcius{50, 51, 53, 52, 51}}
	memory := MemoryUsage{[]Bytes{800000, 8000000, 810000, 820000, 800000}}
